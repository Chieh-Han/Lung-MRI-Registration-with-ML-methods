...
def model_function(hp,
    ...
    #            value is 0. 7 is recommended value here
    ...
    # print((data_definition.input_shape))
    # print((data_definition.output_shape))
...
loss_type = 'MI'  # 'MSE' or 'TukeyBiweight' or 'NCC' or 'MutualInformation', or any other loss type you define
regul_weight = 1.2
'''
...
if BIDIR:
    ...
    losses_weights = [1.0, regul_weight]
...
if EVAL:
    ...
    project.log(">>> Metrics...")
    if BIDIR == True:
        X, Y, Y_reg, Y_neg, Y_fwdfield = model.infer_data(
            test_samples,
            batch_size=3,
        ...
        X, Y, Y_reg, Y_fwdfield, Y_posfwd = model.infer_data(
            test_samples,
            batch_size=3,
            checkpoint="last_phase",
            postprocess=False,
        ...
        np.savez(
            ...
            Y_reg=Y_reg,
            Y_fwdfield=Y_fwdfield,
            Y_posfwd = Y_posfwd, # activate it when Vector Integration (int_step = 7) is active
        )
'''
    # # Evaluate metrics
